...
ggplot(data_hosp_beds_pc, mapping = aes(x = hosp_beds_pc, y = mortality_rate, color
      = continent)) + geom_point() + labs(title = "COVID-19 mortality rate and number of hospital beds available", subtitle = "All countries", x = "Number of hospital beds", y = "Mortality rate")

ggplot(data_hosp_beds_pc_wo_outliers, mapping = aes(x = hosp_beds_pc, y = mortality_rate, color
      = continent)) + geom_point() + labs(title = "COVID-19 mortality rate and number of hospital beds available", subtitle = "No outliers", x = "Number of hospital beds", y = "Mortality rate")
```
