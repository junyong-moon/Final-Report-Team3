...
ggplot(data, aes(y=deaths_cum_per_million, x=health_exp_pc)) +
    ...
    labs(title = "Health Expenses vs. COVID-19-associated deaths per million",
         subtitle = "All Countries", y = "Deaths per million", x = "Health Expensees")
...
cor_hosp_beds <- cor(data_hosp_beds_pc$hosp_beds_pc, data_hosp_beds_pc$deaths_cum_per_million, use = "complete.obs")
cor_hosp_beds
...
cor_health_index <- cor(data_health_index$health_index, data_health_index$deaths_cum_per_million, use = "complete.obs")
cor_health_index
